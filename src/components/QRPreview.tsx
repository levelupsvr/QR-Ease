...
const QRPreview = ({ settings }: QRPreviewProps) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-tuscan-red p-8 h-full flex flex-col items-center justify-center"
    >
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-raisin-black dark:text-silver-pink mb-2">
          Live Preview
        </h2>
      ...
      >
        {!settings.data ? (
          <div className="w-80 h-80 bg-silver-pink dark:bg-raisin-black flex items-center justify-center border-2 border-dashed border-tan dark:border-rosy-brown">
      ...
      {isGenerating && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="absolute inset-0 flex items-center justify-center bg-white/50 dark:bg-tuscan-red/50"
        >
